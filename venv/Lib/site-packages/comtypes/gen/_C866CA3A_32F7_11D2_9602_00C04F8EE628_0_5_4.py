...
__all__ = [
    'DISPID_SADefaultFormat', 'DISPID_SPCIdToPhone', 'SDTAudio',
    'ISpPhoneticAlphabetConverter',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SRAONone',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRCEInterference',
    'SPCT_DICTATION', 'DISPID_SBSSeek', 'SSSPTRelativeToEnd',
    'SpeechLexiconType', 'ISpRecognizer', 'DISPID_SLWsItem',
    'IStream', 'SVSFVoiceMask', 'SpeechEngineConfidence',
    'DISPID_SGRAddResource', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SGRSTText', 'eLEXTYPE_PRIVATE16', 'tagSTATSTG',
    'SPSModifier', 'ISpeechMMSysAudio', 'DISPID_SPPId',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPPsCount',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SABufferNotifySize',
    'SVSFlagsAsync', 'ISpLexicon', 'DISPID_SDKEnumKeys',
    'DISPID_SRCreateRecoContext', 'SGRSTTTextBuffer',
    'DISPID_SDKDeleteValue', 'eLEXTYPE_APP', 'SVSFParseSapi',
    'SVSFUnusedFlags', 'SPEI_MIN_SR', 'eLEXTYPE_PRIVATE6',
    'SPEI_END_SR_STREAM', 'DISPID_SRCEAudioLevel',
    'DISPID_SPEs_NewEnum', 'DISPID_SPELexicalForm',
    'SPADAPTATIONRELEVANCE', 'SRTReSent', 'SPEI_PROPERTY_NUM_CHANGE',
    'SAFT12kHz8BitStereo', 'SDA_No_Trailing_Space', 'SVEWordBoundary',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpeechRecognizerStatus',
    'SPWT_LEXICAL', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpShortcut', 'eWORDTYPE_DELETED', 'SPPS_RESERVED2',
    'SPEI_RESERVED3', 'SAFT48kHz16BitStereo', 'DISPID_SLGetWords',
    'STSF_AppData', 'SPAR_Medium', 'DISPID_SVPause',
    'DISPID_SGRSTPropertyName', 'SpMMAudioOut', 'SPPARTOFSPEECH',
    'SPBINARYGRAMMAR', 'SP_VISEME_17', 'SRTSMLTimeout', 'SPVPRIORITY',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SMSAMMHandle',
    'SPVPRI_OVER', 'SVP_17', 'SDA_One_Trailing_Space', 'SITooFast',
    ...
    'SP_VISEME_20', 'DISPID_SVPriority', 'SDKLDefaultLocation',
    'SREPrivate', 'DISPID_SRRTimes', 'DISPID_SpeechAudioBufferInfo',
    'SAFT12kHz16BitMono', 'SLODynamic', 'DISPID_SPEAudioStreamOffset',
    'SPVPRI_ALERT', 'DISPID_SRIsUISupported', 'DISPID_SPPs_NewEnum',
    'DISPID_SRCESoundStart', 'SPAO_RETAIN_AUDIO',
    'DISPID_SGRSAddWordTransition', 'SSFMOpenReadWrite',
    'DISPID_SGRsAdd', 'DISPID_SPRText', 'SPPS_Modifier',
    'DISPID_SPRsItem', 'DISPID_SVGetAudioOutputs',
    'SAFT32kHz16BitMono', 'ISpeechPhraseAlternates',
    'ISpeechLexiconPronunciations', 'SVSFNLPSpeakPunc',
    'SpeechRecognitionType', 'SPAUDIOSTATE', 'DISPID_SWFEChannels',
    'DISPID_SVEPhoneme', 'SPRULESTATE', 'SpeechGrammarTagDictation',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTADPCM_22kHzMono', 'SLTUser',
    'SPSHORTCUTPAIRLIST', 'SPEI_HYPOTHESIS', 'DISPID_SPARecoResult',
    'DISPID_SGRSTPropertyValue', 'SPBOOKMARKOPTIONS', 'SPRST_ACTIVE',
    'SPGS_EXCLUSIVE', 'SpeechRuleState', 'SPEI_RECOGNITION',
    'SRSEDone', 'SPSERIALIZEDPHRASE', 'SREStreamStart',
    'ISpeechObjectTokenCategory', 'SPWT_PRONUNCIATION',
    'SAFT22kHz16BitMono', 'DISPID_SpeechPhraseBuilder',
    'SpFileStream', 'SINoSignal', 'SAFT11kHz16BitMono',
    'Speech_StreamPos_RealTime', 'SpeechGrammarTagUnlimitedDictation',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'eWORDTYPE_ADDED',
    'SPEI_TTS_PRIVATE', 'DISPID_SRCRetainedAudioFormat',
    'ISpeechPhraseInfoBuilder', 'DISPID_SMSSetData',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SRSEIsSpeaking',
    'DISPID_SPCPhoneToId', 'DISPID_SpeechPhraseRules',
    'eLEXTYPE_PRIVATE13', 'DISPID_SVSCurrentStreamNumber',
    'SpeechAddRemoveWord', 'SPPS_Noun', 'DISPID_SpeechRecoResult',
    ...
    'DISPID_SRRAudioFormat', 'DISPID_SABIBufferSize',
    'ISpeechPhraseProperty', 'DISPID_SpeechVoiceStatus',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpPhrase', 'SPWF_INPUT',
    'SP_VISEME_15', 'SAFT24kHz16BitStereo', 'eLEXTYPE_PRIVATE19',
    'DISPID_SPEActualConfidence', 'DISPID_SRState',
    'DISPID_SOTCSetId', 'DISPID_SpeechAudio', 'STCAll',
    'DISPID_SVEEnginePrivate', 'DISPID_SPACommit',
    'DISPID_SRCEEnginePrivate', 'DISPID_SOTCDefault',
    'eLEXTYPE_RESERVED10', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPISaveToMemory', 'DISPID_SFSOpen',
    'SAFTCCITT_ALaw_44kHzStereo', 'SLOStatic', 'ISpNotifySink',
    'DISPID_SPAsItem', 'DISPID_SPIProperties', 'DISPID_SDKEnumValues',
    'DISPID_SRCBookmark', 'DISPID_SRGReset', 'ISpeechResourceLoader',
    'SAFT32kHz8BitMono', 'DISPID_SPERetainedStreamOffset',
    'SREAudioLevel', 'DISPID_SpeechRecognizer',
    'DISPID_SOTGetStorageFileName', 'DISPID_SVVoice',
    'DISPID_SRRSpeakAudio', 'eLEXTYPE_VENDORLEXICON', 'SPSLMA',
    ...
    'SGDSInactive', 'ISpObjectTokenCategory', 'DISPID_SASState',
    'eLEXTYPE_PRIVATE9', 'ISpStreamFormat', 'Speech_Max_Pron_Length',
    'SpeechCategoryRecognizers', 'SpNullPhoneConverter',
    'DISPID_SLGetGenerationChange', 'SpeechStreamFileMode',
    'SpeechRecoContextState', 'DISPID_SVSLastResult', 'SRAImport',
    'DISPID_SABIEventBias', 'DISPID_SPCLangId', 'DISPID_SDKOpenKey',
    ...
    'SPRECORESULTTIMES', 'DISPID_SpeechFileStream', 'SpObjectToken',
    'SGRSTTRule', 'SAFT11kHz16BitStereo', 'DISPID_SVEBookmark',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechTokenIdUserLexicon',
    'SPEI_SENTENCE_BOUNDARY', 'SAFT44kHz16BitMono', 'DISPID_SLPType',
    'DISPIDSPRG', 'DISPID_SpeechCustomStream',
    'DISPID_SpeechPhraseReplacement', 'SpeechEmulationCompareFlags',
    'ISpeechRecoGrammar', 'SPPS_Unknown', 'DISPID_SRCERecognition',
    'DISPID_SVResume', 'DISPID_SLPSymbolic', 'SVP_1', 'SVPAlert',
    '__MIDL_IWinTypes_0009', 'SDTProperty', 'SRESoundStart',
    'ISpeechPhraseReplacement', 'ISpVoice',
    'DISPID_SVSInputWordPosition', 'SAFT32kHz8BitStereo',
    'SAFT48kHz8BitMono', 'ISpeechPhoneConverter',
    'DISPID_SOTCategory', 'SPGRAMMARWORDTYPE', 'SPDKL_CurrentUser',
    'SPPS_RESERVED1', 'SpeechRegistryLocalMachineRoot', 'SVP_12',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechPhraseInfo',
    'SDTLexicalForm', 'ISpeechLexicon', 'SPWORDPRONUNCIATION',
    'SP_VISEME_7', 'SpAudioFormat', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SRGState', 'SAFT24kHz8BitStereo',
    'SREPropertyStringChange',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPIAudioStreamPosition', 'SAFTText', 'SPAS_CLOSED',
    'SP_VISEME_19', 'ISpRecoGrammar2', 'DISPID_SPRDisplayAttributes',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpPhraseInfoBuilder',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRRAlternates',
    'SPEI_MAX_TTS', 'SRCS_Enabled', 'SAFTCCITT_uLaw_11kHzStereo',
    'SASClosed', 'DISPID_SDKSetLongValue', 'SPSInterjection',
    'SVP_18', 'DISPID_SVSLastStreamNumberQueued', 'SPGS_ENABLED',
    'SAFTCCITT_uLaw_22kHzMono', 'SSTTDictation', 'ISpAudio',
    'DISPID_SVSInputSentencePosition', 'DISPID_SLPPhoneIds',
    'SPCS_ENABLED', 'SpeechPropertyAdaptationOn', 'DISPID_SMSGetData',
    'SPEVENTENUM', 'SVEViseme', 'SWTAdded',
    ...
    'SAFT44kHz8BitStereo', 'DISPID_SVSInputSentenceLength',
    'SPVOICESTATUS', 'DISPID_SPIRule', 'DISPID_SRSSupportedLanguages',
    'SPRST_NUM_STATES', 'SVEPrivate', 'SP_VISEME_4',
    'DISPID_SRGDictationUnload', 'SREPhraseStart', 'SPEI_REQUEST_UI',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRCAudioInInterferenceStatus',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPPsItem',
    'ISpeechPhraseAlternate', 'DISPID_SpeechPhoneConverter',
    'SpeechVoiceSpeakFlags', 'SP_VISEME_14', 'SPPS_SuppressWord',
    'ISequentialStream', 'DISPID_SRRTLength',
    'SpeechAudioFormatGUIDText', 'eLEXTYPE_RESERVED8',
    'SPDKL_LocalMachine', 'DISPID_SRGCommit', 'SpeechRecoEvents',
    'SVF_Emphasis', 'SPINTERFERENCE', 'SpeechRecoProfileProperties',
    'SRSInactive', 'SP_VISEME_12', 'DISPID_SRCEventInterests',
    'ISpRecoCategory', 'DISPID_SPRuleParent',
    'SWPUnknownWordPronounceable', 'SPSVerb', 'SPAUDIOOPTIONS',
    'SAFT22kHz8BitStereo', 'SGSDisabled', 'DISPID_SpeechPhraseRule',
    'DISPID_SGRInitialState', 'SVEVoiceChange', 'SpCustomStream',
    'DISPID_SVEViseme', 'SPEI_RESERVED6', 'SAFT8kHz8BitMono',
    'SVSFPurgeBeforeSpeak', 'DISPID_SLWsCount', 'eLEXTYPE_PRIVATE2',
    'SpeechWordType', 'SPEI_PHRASE_START', 'SECHighConfidence',
    'DISPID_SLRemovePronunciation', 'DISPID_SpeechRecoResult2',
    'SVSFIsFilename', 'SVP_3', 'SVF_None', 'SAFT8kHz16BitStereo',
    'ISpObjectWithToken', 'SPLO_STATIC', 'IInternetSecurityManager',
    'SP_VISEME_9', 'SpeechAudioState', 'SAFTADPCM_44kHzStereo',
    'DISPID_SOTDataKey', 'DISPID_SRGSetTextSelection', 'SSTTWildcard',
    'SpeechPartOfSpeech', 'DISPID_SWFESamplesPerSec', 'SVPNormal',
    'DISPID_SDKSetStringValue', 'SpeechCategoryAudioOut',
    'DISPID_SPIReplacements', 'SPRS_INACTIVE',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SECFEmulateResult',
    'DISPID_SABufferInfo', 'DISPID_SOTIsUISupported', 'SpLexicon',
    'SPAUDIOBUFFERINFO', 'SpeechUserTraining',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SLWPronunciations',
    '_RemotableHandle', 'ISpeechLexiconWords',
    'SpeechCategoryAudioIn', 'SAFT44kHz8BitMono',
    'DISPID_SRCEEndStream', 'SECLowConfidence', 'SAFT24kHz8BitMono',
    'DISPID_SVIsUISupported', 'SPAR_Unknown', 'SPFM_CREATE',
    'SpPhoneConverter', 'SDTRule', 'DISPID_SPPConfidence',
    ...
    'SPRST_INACTIVE_WITH_PURGE', 'SPSHORTCUTPAIR', 'DISPID_SLWWord',
    'DISPID_SRAudioInput', 'SRTExtendableParse',
    'DISPID_SOTDisplayUI', 'DISPID_SPILanguageId', 'DISPID_SRRAudio',
    'DISPID_SpeechXMLRecoResult', 'ISpeechGrammarRuleStateTransition',
    'ISpeechTextSelectionInformation', 'DISPID_SRSetPropertyString',
    'SGDSActiveUserDelimited', 'SRAORetainAudio',
    'DISPID_SRSClsidEngine', 'DISPID_SpeechPhraseProperty',
    'DISPID_SGRSTNextState', 'ISpPhraseAlt', 'SWTDeleted',
    'ISpeechGrammarRuleState', 'SpInProcRecoContext',
    'ISpeechAudioFormat', 'DISPID_SWFEBlockAlign',
    'DISPID_SVAudioOutput', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SRRSaveToMemory', 'ISpRecoContext2',
    'SpObjectTokenCategory', 'SPCT_SUB_COMMAND', 'SVP_5',
    'SAFTDefault', 'SPCATEGORYTYPE', 'SPSHT_EMAIL',
    'SpeechPropertyResourceUsage', 'SREAllEvents',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpeechRecoResultTimes',
    'ISpeechAudio', 'SVP_15', 'ISpeechPhraseElement',
    'SpeechMicTraining', 'SVSFParseAutodetect', 'SVP_14',
    'ISpeechVoiceStatus', 'SRCS_Disabled', 'Speech_Max_Word_Length',
    'SpeechVisemeFeature', 'DISPID_SPPFirstElement',
    'DISPID_SGRSTsItem', 'SP_VISEME_21', 'ISpeechRecoResultDispatch',
    'DISPID_SPEAudioSizeBytes', 'SVEStartInputStream',
    'SAFT11kHz8BitMono', 'SPPROPERTYINFO', 'SPSERIALIZEDRESULT',
    'DISPID_SRGCmdLoadFromObject', 'ISpeechXMLRecoResult',
    'DISPID_SGRsCommit', 'ISpStream', 'SPPS_RESERVED3',
    'SpeechTokenKeyAttributes', 'SAFT16kHz16BitStereo', 'SVP_8',
    'ISpeechLexiconPronunciation', 'SP_VISEME_5',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPFILEMODE', 'SVP_10',
    'eLEXTYPE_PRIVATE15', 'SGRSTTWord', 'DISPID_SPEsCount',
    'SPFM_CREATE_ALWAYS', 'SPWORD', 'ISpeechRecoResult',
    'DISPID_SWFEBitsPerSample', 'SpeechAudioFormatType', 'SGDSActive',
    'SPLO_DYNAMIC', 'SpeechTokenValueCLSID', 'SP_VISEME_11',
    'ISpeechPhraseInfo', 'SVP_0', 'ISpeechPhraseRule',
    'DISPID_SAFGuid', 'DISPID_SpeechGrammarRules',
    'DISPID_SDKGetBinaryValue', 'DISPID_SGRId',
    'DISPID_SRGDictationSetState', 'DISPID_SPRuleId',
    'SPPHRASEREPLACEMENT', 'SAFT12kHz16BitStereo',
    'SpeechDisplayAttributes', 'SASRun',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPIAudioSizeTime',
    'SPFM_NUM_MODES', 'LONG_PTR', 'SVPOver',
    'DISPID_SpeechPhraseProperties', 'eLEXTYPE_PRIVATE4',
    'ISpProperties', 'DISPID_SGRClear', 'SREAdaptation',
    'DISPID_SPPParent', 'IEnumString', 'SAFTExtendedAudioFormat',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SVGetProfiles',
    'DISPID_SPIEngineId', 'DISPID_SRCEAdaptation', 'SRSActive',
    'SPBO_TIME_UNITS', 'SRERequestUI', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SGRSAddRuleTransition', 'SPSEMANTICFORMAT',
    'SAFTADPCM_8kHzMono', 'SPPS_Noncontent', 'SpeechTokenShellFolder',
    'SPWORDTYPE', 'DISPID_SGRSRule', 'ISpeechWaveFormatEx',
    'SPFM_OPEN_READONLY', 'DISPID_SVGetVoices',
    'DISPID_SVSInputWordLength', 'SPEI_UNDEFINED', 'SPPHRASERULE',
    'SPEI_MAX_SR', 'DISPID_SpeechLexiconPronunciation',
    'SVESentenceBoundary', 'SPWORDLIST', 'DISPID_SGRSTRule',
    'DISPID_SPIGrammarId', 'DISPID_SRGDictationLoad',
    'eLEXTYPE_RESERVED4', 'SECFDefault',
    'DISPID_SASCurrentDevicePosition',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRCERecognizerStateChange', 'SPDKL_CurrentConfig',
    'SREInterference', 'ISpeechLexiconWord', 'DISPID_SVEVoiceChange',
    'SpTextSelectionInformation', 'SPWT_DISPLAY', 'STCLocalServer',
    'DISPID_SRCResume', 'IInternetSecurityMgrSite',
    'eLEXTYPE_RESERVED9', 'DISPID_SBSRead', 'DISPID_SOTId',
    'SpMMAudioIn', 'SRSActiveAlways', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechCategoryRecoProfiles', 'SpInprocRecognizer',
    'DISPID_SPRuleName', 'DISPID_SRGId', 'ISpRecoContext',
    'DISPID_SOTMatchesAttributes', 'ISpResourceManager',
    'SpeechTokenKeyUI', 'DISPID_SRGCmdSetRuleIdState',
    'SDTReplacement', 'SPTEXTSELECTIONINFO', 'SINoise',
    'SpeechGrammarTagWildcard', 'DISPID_SOTs_NewEnum',
    'DISPID_SPEAudioSizeTime', 'SDTAll', 'DISPID_SDKSetBinaryValue',
    'DISPID_SCSBaseStream', 'SPINTERFERENCE_NOSIGNAL',
    'SAFT48kHz16BitMono', 'DISPID_SVRate',
    'ISpeechGrammarRuleStateTransitions', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPRules_NewEnum', 'Speech_Default_Weight',
    'SpeechVisemeType', 'SAFTADPCM_8kHzStereo', 'DISPID_SPRulesCount',
    'SP_VISEME_8', 'ISpRecognizer2', 'SpCompressedLexicon',
    'SPGRAMMARSTATE', 'DISPIDSPTSI',
    'SpeechPropertyLowConfidenceThreshold', 'SPEVENT', 'ISpShortcut',
    'DISPID_SGRSTsCount', 'DISPID_SPAStartElementInResult', 'SPRULE',
    'DISPID_SBSFormat', 'SPCS_DISABLED', 'DISPID_SRCEBookmark',
    'ISpeechRecoResult2', 'SAFT16kHz16BitMono', 'SVP_16',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVP_11', 'SPPS_Interjection',
    ...
    'DISPID_SAVolume', 'SVP_9',
    'DISPID_SRCERecognitionForOtherContext', 'SpeechDiscardType',
    'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPAPhraseInfo', 'SPEI_RESERVED2', 'SVP_21',
    'SGSExclusive', 'ISpeechGrammarRules', 'SPGS_DISABLED',
    'SVSFNLPMask', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpeechSpecialTransitionType',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SVSkip',
    'SPXRO_Alternates_SML', 'SPWAVEFORMATTYPE',
    'DISPID_SPERequiredConfidence', 'SpeechLoadOption',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechObjectTokens',
    'SpMemoryStream', 'DISPID_SOTsCount', 'DISPID_SASNonBlockingIO',
    'SITooSlow', 'DISPID_SRGIsPronounceable',
    'DISPID_SpeechObjectToken', 'DISPID_SpeechPhraseAlternate',
    'eLEXTYPE_PRIVATE18', 'SPSNoun', 'SPEI_WORD_BOUNDARY',
    'DISPID_SABIMinNotification', 'SAFT44kHz16BitStereo',
    'ISpGrammarBuilder', 'DISPID_SOTGetAttribute',
    'ISpeechPhraseRules', 'SECFNoSpecialChars',
    'SpeechDataKeyLocation', 'DISPID_SGRsFindRule', 'STSF_FlagCreate',
    'eLEXTYPE_PRIVATE20', 'SPEI_MIN_TTS',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPPValue', 'SpPhoneticAlphabetConverter', 'SPPS_Function',
    'ISpDataKey', 'eLEXTYPE_PRIVATE8', 'DISPID_SpeechLexiconWord',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpSharedRecoContext',
    'DISPID_SPEsItem', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SMSADeviceId', 'DISPID_SPRuleEngineConfidence',
    'SPCT_COMMAND', 'SAFT16kHz8BitStereo',
    'DISPID_SpeechObjectTokens', 'DISPID_SOTsItem', 'WAVEFORMATEX',
    'DISPID_SVEStreamEnd', 'ISpeechPhraseElements', 'SPEI_ADAPTATION',
    'DISPID_SLWs_NewEnum', 'SGPronounciation', 'ISpeechRecoContext',
    'eLEXTYPE_RESERVED7', 'SP_VISEME_6', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SpeechLexicon', 'DISPID_SVSLastBookmark',
    'DISPID_SRGetRecognizers', 'DISPID_SWFEExtraData',
    'SpeechTokenKeyFiles', 'SSSPTRelativeToStart',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SVEEndInputStream',
    'ISpeechPhraseReplacements', 'ISpRecoGrammar',
    'SPEI_END_INPUT_STREAM', 'SAFTCCITT_ALaw_11kHzMono',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SAEventHandle',
    'DISPID_SpeechPhraseAlternates', 'SVEAudioLevel', 'SDTAlternates',
    'SpeechAudioVolume', 'SpeechGrammarState',
    'DISPID_SDKGetlongValue', 'DISPID_SOTCEnumerateTokens',
    'SPSFunction', 'SITooLoud', 'SPVPRI_NORMAL', 'ISpeechBaseStream',
    'SSFMOpenForRead', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SAFT11kHz8BitStereo', 'SPPHRASEPROPERTY', 'SRARoot',
    'SPCONTEXTSTATE', 'SRSInactiveWithPurge',
    'DISPID_SPRuleConfidence', 'SRTAutopause',
    'DISPID_SRRTOffsetFromStart', 'SDKLLocalMachine',
    'SpWaveFormatEx', 'DISPID_SPIElements', 'SBONone',
    'DISPID_SVDisplayUI', 'ISpeechRecognizer', 'SVP_7',
    'DISPID_SRCCreateGrammar', 'SPRECOGNIZERSTATUS',
    'DISPID_SVSPhonemeId', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SpeechRecoResultTimes', 'SREStreamEnd', 'SPBO_NONE',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRRGetXMLErrorInfo',
    'SP_VISEME_2', 'SPEI_START_INPUT_STREAM', 'SP_VISEME_3',
    'SpeechEngineProperties', 'SPPS_RESERVED4',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SVEWord',
    'DISPID_SRSAudioStatus', 'SPEI_SR_RETAINEDAUDIO', 'SVF_Stressed',
    'SPSHT_OTHER', 'DISPID_SRGetPropertyString',
    'DISPID_SDKDeleteKey', 'SREHypothesis', 'SVSFIsNotXML',
    'DISPID_SVSpeak', 'eLEXTYPE_RESERVED6', 'SRTEmulated',
    'SPAS_PAUSE', 'SPSMF_UPS', 'DISPID_SRGRules', 'DISPID_SGRSTType',
    'DISPID_SPEDisplayAttributes', 'SAFT8kHz16BitMono',
    'SPAUDIOSTATUS', 'SpeechAudioFormatGUIDWave', 'SPSSuppressWord',
    'SREFalseRecognition', 'SBOPause', 'DISPID_SRGRecoContext',
    'DISPID_SRSCurrentStreamPosition', 'SP_VISEME_13',
    'DISPID_SLPsItem', 'SPPS_Verb', 'SPEI_RESERVED1',
    'ISpObjectToken', 'ISpeechAudioStatus',
    'DISPID_SWFEAvgBytesPerSec', 'SVP_20',
    'DISPID_SpeechMemoryStream', 'STSF_CommonAppData', 'SPEI_PHONEME',
    'DISPID_SASFreeBufferSpace', 'ISpeechObjectToken',
    'SVSFParseSsml', 'SPLOADOPTIONS', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SPRNumberOfElements', 'SPCT_SUB_DICTATION', 'SRESoundEnd',
    'SAFT16kHz8BitMono', 'DISPID_SRCSetAdaptationData',
    'eLEXTYPE_PRIVATE12', 'DISPID_SGRSTs_NewEnum',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRGCmdLoadFromFile',
    '_ISpeechVoiceEvents', 'DISPID_SPPName',
    'DISPID_SPIAudioSizeBytes', 'SpeechDictationTopicSpelling',
    ...
    'DISPID_SVEAudioLevel', 'ISpeechCustomStream',
    'SAFT32kHz16BitStereo', 'DISPID_SpeechLexiconProns',
    'SPLEXICONTYPE', 'SPRST_INACTIVE', 'DISPID_SRCRequestedUIType',
    'SAFTGSM610_22kHzMono', 'SPDATAKEYLOCATION', 'SVP_19',
    ...
    'SAFT8kHz8BitStereo', 'SVEBookmark', 'SFTSREngine',
    'STCInprocServer', 'SGRSTTDictation',
    'SpeechStreamSeekPositionType', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SBSWrite', 'SPSUnknown', 'DISPID_SREmulateRecognition',
    'SPEI_SOUND_END', 'SP_VISEME_18', 'DISPID_SLAddPronunciation',
    ...
    'DISPID_SFSClose', 'SPWORDPRONUNCIATIONLIST', 'eLEXTYPE_PRIVATE1',
    ...
    'DISPID_SRCRecognizer', 'SAFTNonStandardFormat', 'SPXRO_SML',
    'SRADynamic', 'DISPID_SpeechBaseStream', 'ISpeechMemoryStream',
    'SPSNotOverriden', 'SPAO_NONE', 'DISPIDSPTSI_SelectionOffset',
    'SAFTADPCM_44kHzMono', 'ISpEventSource',
    'SpeechWordPronounceable', 'DISPID_SRProfile',
    'SpeechPropertyHighConfidenceThreshold', 'SpeechFormatType',
    'SRATopLevel', 'SRAExport', 'DISPID_SGRSTransitions',
    'DISPID_SRDisplayUI', 'SGLexical', 'SPINTERFERENCE_NONE',
    'SpeechRecognizerState', 'SPBO_PAUSE', 'DISPID_SRCPause',
    'DISPID_SVGetAudioInputs', 'DISPID_SPEPronunciation',
    'DISPID_SGRsItem', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SOTCId',
    'SpeechRuleAttributes', 'SPVISEMES', 'DISPID_SOTSetId',
    'DISPID_SGRs_NewEnum', 'SPEI_SR_AUDIO_LEVEL', 'ISpXMLRecoResult',
    'DISPID_SRCERequestUI', 'SINone', 'Speech_StreamPos_Asap',
    'DISPID_SGRsCommitAndSave', 'eLEXTYPE_MORPHOLOGY',
    'SpeechAllElements', 'DISPID_SVStatus', 'SpeechVoiceEvents',
    'DISPID_SLPPartOfSpeech', 'SAFT48kHz8BitStereo',
    'eLEXTYPE_PRIVATE14', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRCVoicePurgeEvent', 'SpeechTokenContext',
    'DISPID_SPPEngineConfidence', 'SP_VISEME_1', 'UINT_PTR',
    'SPBO_AHEAD', 'SPCT_SLEEP', 'SAFTGSM610_8kHzMono',
    'SPSHT_NotOverriden', 'DISPID_SRAudioInputStream',
    'eLEXTYPE_PRIVATE11', 'SGDisplay', 'DISPID_SVAlertBoundary',
    'DISPID_SRGetFormat', 'eLEXTYPE_PRIVATE3', 'SDTDisplayText',
    'SpeechRetainedAudioOptions', 'SPEI_SR_PRIVATE',
    'SPXMLRESULTOPTIONS', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPINTERFERENCE_TOOFAST', 'SPEI_TTS_BOOKMARK', 'SP_VISEME_10',
    'DISPID_SRGetPropertyNumber', 'ISpMMSysAudio',
    'DISPID_SPRuleChildren', 'SSFMCreate', 'ISpRecoResult',
    'DISPID_SLPsCount', 'ISpeechAudioBufferInfo', 'SAFT22kHz8BitMono',
    'DISPID_SPRsCount', 'DISPID_SpeechWaveFormatEx', 'SVP_13',
    'SpeechVoicePriority', 'SGSEnabled', 'DISPID_SpeechRecoContext',
    'SVEAllEvents', 'SpeechAudioProperties', 'DISPID_SPAs_NewEnum',
    ...
    'DISPID_SAStatus', 'DISPID_SPRFirstElement',
    'DISPID_SGRSTPropertyId', 'SPDKL_DefaultLocation', 'SPEI_VISEME',
    'SpeechRunState', 'SITooQuiet', 'DISPID_SWFEFormatTag',
    'SGDSActiveWithAutoPause', 'SECFIgnoreWidth',
    'DISPID_SPERetainedSizeBytes',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SRERecoOtherContext',
    'DISPID_SRStatus', 'SDKLCurrentConfig', 'SGRSTTEpsilon', 'SVP_2',
    'SGRSTTWildcard', 'SPSTREAMFORMATTYPE', 'DISPID_SPIStartTime',
    'DISPID_SRSetPropertyNumber', 'DISPID_SMSALineId',
    'IEnumSpObjectTokens', 'SpeechGrammarWordType', 'SVSFIsXML',
    'DISPID_SGRSTWeight', 'DISPID_SLGetPronunciations',
    'SPSHT_Unknown', 'SVEPhoneme', 'SPEI_START_SR_STREAM',
    'SPAR_High', 'SDKLCurrentUser', 'SpVoice',
    'SAFTADPCM_22kHzStereo', 'eLEXTYPE_PRIVATE17', 'ISpeechVoice',
    'SVP_6', 'SpeechInterference', 'DISPID_SLPLangId',
    'DISPID_SASetState', 'DISPID_SpeechDataKey', 'SSFMCreateForWrite',
    'SpeechCategoryVoices', 'eLEXTYPE_USER', 'SFTInput',
    'DISPID_SRRecognizer', 'SAFTTrueSpeech_8kHz1BitMono',
    'SECNormalConfidence', 'SPPS_NotOverriden', 'ISpEventSink',
    'DISPID_SRRPhraseInfo', 'SPEVENTSOURCEINFO', 'DISPID_SVSVisemeId',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPEI_RECO_STATE_CHANGE',
    'SVSFDefault', 'SRTStandard', 'DISPID_SpeechAudioStatus',
    'SPEI_VOICE_CHANGE', 'SPEI_RESERVED5', 'ISpNotifySource',
    'ISpStreamFormatConverter', 'SPPHRASE', 'SPRS_ACTIVE',
    'DISPID_SRIsShared', 'tagSPTEXTSELECTIONINFO',
    'ISpNotifyTranslator', 'DISPID_SRCVoice',
    'DISPID_SVAudioOutputStream', 'DISPID_SLPs_NewEnum', 'SPAS_STOP',
    'SpResourceManager', 'SP_VISEME_16', 'DISPID_SRRTTickCount',
    'SASStop', 'SpStream', 'ISpPhoneConverter', 'SASPause', 'SVP_4',
    'DISPID_SVVolume', '_SPAUDIOSTATE',
    'DISPID_SRCEPropertyStringChange', 'SRERecognition',
    'DISPID_SOTRemove', 'SSTTTextBuffer', 'DISPID_SLGenerationId',
    'DISPID_SPAsCount', 'SpeechBookmarkOptions',
    'SPWORDPRONOUNCEABLE', 'DISPID_SpeechLexiconWords',
    'DISPID_SVESentenceBoundary', 'DISPID_SRCRetainedAudio',
    'DISPID_SpeechRecoContextEvents', 'SPEI_INTERFERENCE',
    ...
    'DISPID_SGRAddState', 'DISPID_SRRDiscardResultInfo', 'SPPS_LMA',
    'SPEI_SOUND_START', 'SpNotifyTranslator', 'SLTApp',
    'DISPID_SRCEPhraseStart', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SAFTNoAssignedFormat', 'DISPID_SPRuleFirstElement', 'SPAS_RUN',
    'DISPID_SPRuleNumberOfElements', 'SDA_Two_Trailing_Spaces',
    'STCRemoteServer', 'SpStreamFormatConverter', 'SPAR_Low',
    'ISpeechFileStream', 'DISPID_SRCEStartStream', 'SPRECOSTATE',
    'DISPID_SPRulesItem', 'DISPID_SAFGetWaveFormatEx',
    '_ISpeechRecoContextEvents', 'DISPID_SRRTStreamTime',
    'SREBookmark', 'DISPID_SDKCreateKey', 'DISPID_SAFType',
    'STSF_LocalAppData', 'DISPID_SPPNumberOfElements', 'SP_VISEME_0',
    'SVSFParseMask', 'DISPID_SPPChildren', 'SRAInterpreter',
    'SREStateChange', 'DISPID_SVEventInterests', 'SpMMAudioEnum',
    'ISpeechPhraseProperties', 'SRADefaultToActive', 'ISpeechDataKey',
    'SVSFPersistXML', 'SPSHORTCUTTYPE', 'DISPID_SOTCGetDataKey'
]
